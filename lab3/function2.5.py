...
average_imdb_in_category = calculate_average_imdb_by_category(movies, category_name)
print(f"The average IMDB score in the {category_name} category is: {average_imdb_in_category:.2f}")
